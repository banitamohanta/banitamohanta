...
# <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"/> Hi, I'm Banita Mohanta
...
public:
    ...
    String currentlyWorkingOn = "SafeWithUs";
    String learning = "Java | MERN | AI";
};
```

- 🌱 Learning **Java, MERN Stack & AI**
...
### 🛡️ SafeWithUs
A smart safety platform with live tracking, geofencing, SOS alerts, and emergency monitoring.

---

### 🤖 Igris
Offline AI Voice Assistant built using Python, Vosk, Wake Word Detection, and Text-to-Speech.

---

### 💻 LeetCode Solutions
Daily DSA solutions in Python.
